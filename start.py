...
async def handler(event):
    ...
    await client.send_message(chat,"""I support zee5 and mx player-movies full mx player later develop send me mx players like https://www.mxplayer.in/movie/ba472677b661a6d09ab73f47d33c0c90 """)
...
async def handler(event):
   ...
   # await client.send_file(chat,r1["image_url"],caption = r1["title"])
    ...
    await client.send_message(chat, "support @geekio_0    "+" TITLE:"+r1["title"]+"   DESCRIPTION:"+r1["description"],file=r1["image_url"], buttons=markup)
